...
public class SignHelper {
     ...
     * @return 签名值
     */
    public static String makeSign(String method, Map<String, String> params, String secret) throws Exception {
        Mac mac = Mac.getInstance(HMAC_ALGORITHM);
        SecretKeySpec secretKey = new SecretKeySpec(secret.getBytes(CONTENT_CHARSET), mac.getAlgorithm());
        mac.init(secretKey);
        String mk = makeSource(method, params);
     ...
     * @return 签名所需源串
     */
    public static String makeSource(String method, Map<String, String> params) throws Exception {
        /*
          1.将请求的URI路径进行URL编码
    ...
    public static boolean verifySign(String method, HashMap<String, String> params, String secret, String sign) throws Exception {
        params.remove("sign"); // 确保不含sign
        codePayValue(params); // 按照编码规则对value编码
        String newSign = makeSign(method, params, secret); // 计算签名
