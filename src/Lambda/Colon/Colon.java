...
public class Colon {
    ...
    //当有两个参数时 第一个参数必须是方法调用者，最后一个参数可以是入参也可是方法返回值。
    //当有三个参数时 当有两个参数时 第一个参数必须是方法调用者，中间参数必须是入参，最后一个参数可以是入参也可是方法返回值。
    //当有四个参数时 当有两个参数时 第一个参数必须是方法调用者，中间两个参数必须是入参，最后一个参数可以是入参也可是方法返回值。
    //以此类推
