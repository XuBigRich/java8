...
public class RSACoder {
    ...
    public static void main(String[] args) throws Exception {
        ...
        System.out.println("公钥：" + Base64Utils.encodeBase64String(publicKey));
        System.out.println("私钥：" + Base64Utils.encodeBase64String(privateKey));
        ...
        System.out.println("甲方 使用乙方公钥加密后的数据：" + Base64Utils.encodeBase64String(code1));
        ...
        System.out.println("加密后的数据：" + Base64Utils.encodeBase64String(code2));
