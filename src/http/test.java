...
public class test {
	...
	public static void main(String[] arg) throws IOException{
    	...
    	for(int z=0;z<18;z++){
    		...
    		for(int y=sY;y<=eY;y++){
    			for(int x=sX;x<=eX;x++){
//    				String urlstr = "	http://t0.tianditu.gov.cn/vec_c/wmts?T=cva_c&x="+x+"&y="+y+"&l="+z+"&tk=903765d1138bd9e70dde603044caa4a6"; //天地图服务器t0-t8间选一个
//    				String urlstr = "http://t0.tianditu.gov.cn/img_w/wmts?SERVICE=WMTS&REQUEST=GetTile&VERSION=1.0.0&LAYER=img&STYLE=default&TILEMATRIXSET=w&FORMAT=tiles&TILEMATRIX={"+z+"}&TILEROW={"+x+"}&TILECOL={"+y+"}&tk=903765d1138bd9e70dde603044caa4a6";
    				String urlstr = "https://t0.tianditu.gov.cn/cva_w/wmts?SERVICE=WMTS&REQUEST=GetTile&VERSION=1.0.0&LAYER=cva&STYLE=default&TILEMATRIXSET=w&FORMAT=tiles&TILEMATRIX="+(z+1)+"&TILEROW="+x+"&TILECOL="+y+"&tk=903765d1138bd9e70dde603044caa4a6";
//    				String urlstr = "http://t0.tianditu.gov.cn/img_w/wmts?SERVICE=WMTS&REQUEST=GetTile&VERSION=1.0.0&LAYER=img&STYLE=default&TILEMATRIXSET=w&FORMAT=tiles&TILEMATRIX={z}&TILEROW={x}&TILECOL={y}&tk=903765d1138bd9e70dde603044caa4a6";
